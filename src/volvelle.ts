...
export const VOLVELLE_PHASES: VolvellePhase[] = [
  {
    ...
    target: "O",
    hour: "Dawn",
    title: "1. O - First Lantern / Dragonstone",
    clue:
      "Where the dragon-map first lay under Nordic stone, the earliest lantern wakes. In the Star Ledger, find the first waking mark beside the return of dragons; split the Horizon Atlas at the Dragonborn's beginning after C.",
    hint:
    ...
    reward: "The answer box is the only mouth of the frame. The next road climbs to the mountain of the Voice.",
  ...
  },
  {
    ...
    target: "R",
    hour: "Prime",
    title: "2. R - Voice Oath / High Hrothgar",
    clue:
      "At High Hrothgar, breath is counted before it is shouted. Take the Greybeards' call beside the climb to High Hrothgar, let the disciplined voice answer, and split the horizon at the initials of High Hrothgar's climb.",
    hint:
    ...
    reward: "The spoken gate is not solved by numbers alone; the mark chooses which omen may be heard.",
  ...
  },
  {
    ...
    target: "I",
    hour: "Zenith",
    title: "3. I - Buried Sun / Blackreach",
    clue:
      "Below Skyrim, the false sun of Blackreach crowns the deep. Join the way into hidden depths to the false sun below Skyrim, raise the hidden sun, and let the cavern's first two letters form the horizon.",
    hint:
      "Look for descriptions about hidden depths and the false sun below Skyrim. The Hour Gate meaning is hidden sun.",
    reward: "The buried light teaches the star pair. Two inner signs must sit together before the lens has memory.",
  ...
  },
  {
    ...
    target: "G",
    hour: "Dusk",
    title: "4. G - Turning Wound / Time-Wound",
    clue:
      "At the Time-Wound, old battle and present breath overlap. Pair the wound at the throat of the world with the cold necessity of fate, call the turning of time, and split the horizon where the throat's storm turns.",
    hint:
    ...
    reward: "The turning wound teaches the split horizon. The twin horizon is two halves of the same sightline.",
  ...
  },
  {
    ...
    target: "I",
    hour: "Midnight",
    title: "5. I - Dead Song / Sovngarde",
    clue:
      "In Sovngarde, the dead do not count years; they keep the song. Take Sovngarde's remembered song beside the echo inside Shor's hall, let the night of remembered dead darken, and split the horizon at the two letters that begin the Nordic oath.",
    hint:
    ...
    reward: "The dead song proves recurrence. The same answer may return, but only from a new alignment.",
  ...
  },
  {
    ...
    target: "N",
    hour: "Return",
    title: "6. N - Fixed Point / First Tower",
    clue:
      "When the path leaves Skyrim, seek the first fixed point. Bring the mortal world's fixed weight beside the heart-wound principle, let the first fixed point answer, and split the horizon at the first two letters before any road.",
    hint:
    ...
    reward: "The fixed point seals ORIGIN and opens the premise record.",
